...
const AdminLayout = () => {
  ...
  const menuItems = [
    ...
    { path: '/admin/news', label: 'Yangiliklar', icon: HiOutlineNewspaper, badge: 5 },
    { path: '/admin/courses', label: 'Kurslar', icon: HiOutlineBookOpen },
    { path: '/admin/teachers', label: 'Ustozlar', icon: HiOutlineUser },
    { path: '/admin/groups', label: 'Guruhlar', icon: HiOutlineUserGroup },
    { path: '/admin/students', label: 'O\'quvchilar', icon: HiOutlineUserGroup },
    { path: '/admin/auction', label: 'Auksion', icon: HiOutlineScale },
  ];
        ...
        <div className="px-4 py-4 border-t border-gray-100">
          <div className="flex items-center gap-3 mb-3 px-2">
            ...
            <div className="flex-1 min-w-0">
              <div className="font-semibold text-gray-900 text-[15px] truncate">Robiya Anvarova</div>
