...
const TeacherLayout = () => {
  ...
  const menuItems = [
    ...
    { path: '/teacher/news', label: 'Yangiliklar', icon: HiOutlineNewspaper, badge: 3 },
    ...
    { path: '/teacher/rules', label: 'Baholash Nizomi', icon: HiOutlineClipboardDocumentList },
  ];
        ...
        <div className="px-4 py-4 border-t border-gray-100">
          <div className="flex items-center gap-3 mb-3 px-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-xs text-gray-500 font-medium">Ustoz</div>
            </div>
          </div>
          <button
